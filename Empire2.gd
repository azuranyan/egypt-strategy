...
export var starting_territory: NodePath

# Internal properties
var _starting_territory: Territory
...
# Initialization
func _ready() -> void:
	# Retrieve the starting territory node
	_starting_territory = get_node(starting_territory)
