...
func is_pathable(context: BattleContext, unit: UnitState) -> bool:
	return default_pathable(context, unit) and conditionally_pathable(context, unit)
	

func default_pathable(_context: BattleContext, unit: UnitState) -> bool:
...
func conditionally_pathable(context: BattleContext, unit: UnitState) -> bool:
